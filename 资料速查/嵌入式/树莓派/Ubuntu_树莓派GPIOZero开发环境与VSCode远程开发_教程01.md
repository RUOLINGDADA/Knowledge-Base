...
层级: 理解层
类型: 资料速查型
主题: [Ubuntu, Raspberry Pi, GPIO Zero, GPIO, VS Code Remote-SSH]
技术栈: [ubuntu, linux, python, gpiozero, lgpio, vscode, ssh]
tags: [ubuntu, raspberry-pi, gpiozero, python, vscode, ssh, gpio, 理解层]
状态: 待验证
创建日期: 2026-09-11
来源: 用户对话记录
---

# [技术/嵌入式/树莓派] Ubuntu 使用树莓派：GPIO Zero 与 VS Code 远程开发（教程 01）
